...
describe("Story mode", () => {
    ...
    it("should contains expected step 2 title in the story", () => {
        ...
        cy.contains(
            "Routine monitoring of the efficacy of artemisinin-based combination therapies (ACTs) is essential to ensure that patients receive effective treatment"
        );
    });
    ...
    it("should contains expected step 3 title in the story", () => {
        ...
        cy.contains(
            "Studies of molecular prevention provide essential data for detecting and tracking antimalarial drug resistance"
        );
    });
    ...
    it("should contains expected step 4 title in the story", () => {
        ...
        cy.contains(
            "Drug resistance is a challenge in both P. vivax and P. falciparum, the two most common human malaria parasite species"
        );
    });
});
