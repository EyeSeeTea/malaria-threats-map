...
describe("Open popup", () => {
    ...
    it("should contain all the Kanasar & Khetusar study information ", () => {
        ...
        cy.findByText(
            "Sinka et al. (2020) A new malaria vector in Africa: Predicting the expansion range of Anopheles stephensi and identifying the urban populations at risk, PNAS, DOI: 10.1073/pnas.2003976117ct"
        );
    });
