...
describe("Open popup in insecticide resistance intensity subtheme", () => {
    ...
    it("should open a popup to click on coordinates", () => {
        ...
        cy.contains("Senegal");
        cy.contains("173 test(s) on Anopheles malaria vectors via intensity concentration bioassay(s) with selected Pyrethroids from 2018 to 2019");
    });
...
describe("Open popup in resistance mechanisms detection subtheme", () => {
    ...
    it("should open a popup to click on coordinates", () => {
        cy.clickOnMap(515, 350);
        cy.contains("Senegal");
        cy.contains("35 test(s) on Anopheles malaria vectors via Molecular assays, Biochemical assays, Synergist-insecticide bioassays with selected Pyrethroids from 2015 to 2019");
    });
...
describe("Open popup in insecticide resistance status subtheme", () => {
    ...
    it("should open a popup to click on coordinates", () => {
        cy.clickOnMap(515, 350);
        cy.contains("Senegal");
        cy.contains("578 test(s) on Anopheles malaria vectors via discriminating concentration bioassay(s) with selected Pyrethroids from 2010 to 2019");
    });
