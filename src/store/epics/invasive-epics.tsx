...
export const getInvasiveStudiesEpic = (action$: ActionsObservable<ActionType<typeof fetchInvasiveStudiesRequest>>) =>
        ...
        switchMap(() => {
            ...
            return ajax.get(`/${MapServerConfig.layers.invasive}/query?${query}`).pipe(
                ...
                catchError((error: AjaxError) =>
                    of(addNotificationAction(error.message), fetchInvasiveStudiesError(error))
                )
            );
        })
    );
