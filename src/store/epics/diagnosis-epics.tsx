...
export const getDiagnosisStudiesEpic = (action$: ActionsObservable<ActionType<typeof fetchDiagnosisStudiesRequest>>) =>
        ...
        switchMap(() => {
            ...
            return ajax.get(`/${MapServerConfig.layers.diagnosis}/query?${query}`).pipe(
                ...
                catchError((error: AjaxError) =>
                    of(addNotificationAction(error.message), fetchDiagnosisStudiesError(error))
                )
            );
        })
    );
