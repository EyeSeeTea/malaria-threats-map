...
export const getTreatmentStudiesEpic = (action$: ActionsObservable<ActionType<typeof fetchTreatmentStudiesRequest>>) =>
        ...
        switchMap(() => {
            ...
            return ajax.get(`/${MapServerConfig.layers.treatment}/query?${query}`).pipe(
                ...
                catchError((error: AjaxError) =>
                    of(addNotificationAction(error.message), fetchTreatmentStudiesError(error))
                )
            );
        })
    );
