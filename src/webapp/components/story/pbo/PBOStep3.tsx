    ...
    return (
        <div>
            ...
            <Typography variant={"body2"} className={classes.title}>
                ...
                <Link href={"https://extranet.who.int/pqweb/vector-control-products/prequalified-product-list"} target={"_blank"}>
            ...
            <Typography variant={"body2"} className={classes.title}>
                ...
                <Link
                    href={"https://www.who.int/teams/global-malaria-programme/prevention/vector-control/new-types-of-insecticide-treated-nets"}
                    target={"_blank"}
                >
