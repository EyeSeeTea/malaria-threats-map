  ...
  return (
    <div>
      ...
      <Typography variant={"body2"}>
        Pyrethroid PBO nets are mosquito nets that include both a pyrethroid
        insecticide and the synergist PBO. PBO acts by inhibiting certain
        metabolic enzymes (e.g. mixed-function oxidases) within the mosquito
        that detoxify or sequester insecticides before they can have a toxic
      ...
      <br />
      <Typography variant={"body2"}>
        This recommendation was exceptionally granted in 2017 based on the
        epidemiological data from one cluster RCT and will remain conditional
        until data from at least one more trial conducted over 2 years have
        confirmed the enhanced impact on malaria that was demonstrated in the
        first study.
      </Typography>
      <br />
      <Images>
