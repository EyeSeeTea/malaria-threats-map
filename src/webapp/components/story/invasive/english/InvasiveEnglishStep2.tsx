...
export default function InvasiveEnglishStep2() {
    ...
    return (
        <div>
            ...
            <Typography variant={"body2"}>
                ...
                resistance status is required to design effective interventions to prevent further spread of invasive
                vector species and establishment in new geographical areas.
            </Typography>
            <br />
            <Typography variant={"body2"}>
            ...
            <br />
            <Typography variant={"body2"}>
                Key indicators for entomological surveillance entomological surveillance are listed in chapter 5 of the
                <Link
                    target="_blank"
