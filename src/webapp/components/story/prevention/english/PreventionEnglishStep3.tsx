...
export default function PreventionEnglishStep3() {
    ...
    return (
        <div>
            ...
            <Typography variant={"body2"}>
                <b>
                    47 of 89 malaria-endemic countries reported data for 2017. There are relatively few data in regions
                    other than Africa, such as South-East Asia. Monitoring often does not include all major vector
                    species and all relevant insecticide classes.
                </b>
            </Typography>
            <br />
            <Typography variant={"body2"}>
                ...
                include all major vector species from the different eco-epidemiological zones. Tests should be conducted
                with insecticide classes that are either in use or planned for use in vector control.
            </Typography>
            <br />
            <Typography variant={"body2"}>
