...
export default function PreventionEnglishStep4() {
    ...
    return (
        <div>
            ...
            <Typography variant={"body2"}>
                ...
                confer resistance are important. High intensity resistance warrants urgent action that should be guided
                by knowledge of the underlying resistance mechanisms.
            </Typography>
            <br />
            <Typography variant={"body2"}>
                WHO test procedures were recently extended to include bioassays that measure resistance intensity and
                metabolic mechanism involvement.
            </Typography>
            <br />
            <Link
                href="https://www.who.int/malaria/publications/atoz/9789241511575/"
                target="_blank"
                color={"textSecondary"}
            >
                <img
