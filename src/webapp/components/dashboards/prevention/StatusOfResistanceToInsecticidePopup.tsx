...
const StatusOfResistanceToInsecticidePopup: React.FC<SpecificInformationModalProps> = ({
    years,
    openInfoModal,
    ...
    return (
        <InformationModal
            title={t("common.dashboard.informationModal.statusOfResistanceToInsecticide.title")}
            years={years}
        ...
        >
            <Typography variant="body1">
                <Trans
                    i18nKey="common.dashboard.informationModal.statusOfResistanceToInsecticide.graphInterpretation"
                    t={t}
                >
            ...
            <Typography variant="body1">
                <Trans
                    i18nKey="common.dashboard.informationModal.statusOfResistanceToInsecticide.typeOfResistance"
                    t={t}
                    shouldUnescape={true}
...
export default StatusOfResistanceToInsecticidePopup;
