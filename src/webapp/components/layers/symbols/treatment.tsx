...
const treatmentSymbols = {
    "circle-radius": ["case", ["boolean", ["feature-state", "hover"], false], 7, 6],
    "circle-color": colors.treatment.N,
    "circle-opacity": 1,
    "circle-stroke-color": ["case", ["boolean", ["feature-state", "hover"], false], "lightgrey", colors.treatment.D1],
...
export default treatmentSymbols;
