...
export const TherapeuticEfficacyStudiesColors: { [key: string]: string[] } = {
    ...
    [THERAPEUTIC_EFFICACY_STUDIES_STATUS.COMPLETED]: ["#FD6F21", "#CC5C1E"],
...
const therapeuticEfficacyStudiesSymbols = {
    ...
    "circle-color": [
        ...
        THERAPEUTIC_EFFICACY_STUDIES_STATUS.COMPLETED,
        TherapeuticEfficacyStudiesColors[THERAPEUTIC_EFFICACY_STUDIES_STATUS.COMPLETED][0],
    ...
    "circle-stroke-color": [
        ...
        [
            ...
            THERAPEUTIC_EFFICACY_STUDIES_STATUS.COMPLETED,
            TherapeuticEfficacyStudiesColors[THERAPEUTIC_EFFICACY_STUDIES_STATUS.COMPLETED][1],
