...
function getByMostRecentYearAndTreatmentFailure(group: any[]) {
  ...
  return {
    ...
    TREATMENT_FAILURE_STATUS: resolveTreatmentFailureStatus(
...
function getByMostRecentYearAndMolecularMarker(group: any[]) {
  ...
  return {
    ...filteredSortedStudies[0],
    MOLECULAR_MARKER_STATUS: resolveMolecularMarker(
      filteredSortedStudies[0].VALUE
    )
  };
}
