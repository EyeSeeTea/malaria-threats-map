...
export const DelayedParasiteClearanceColors: { [key: string]: string[] } = {
    [DELAYED_PARASITE_CLEARANCE_STATUS.HIGH]: ["#ff6f00", "#f06800"],
    [DELAYED_PARASITE_CLEARANCE_STATUS.MEDIUM_HIGH]: ["#ff8426", "#f07c24"],
    [DELAYED_PARASITE_CLEARANCE_STATUS.MEDIUM]: ["#ffa159", "#f09957"],
    [DELAYED_PARASITE_CLEARANCE_STATUS.LOW]: ["#ffbe8c", "#f2b484"],
