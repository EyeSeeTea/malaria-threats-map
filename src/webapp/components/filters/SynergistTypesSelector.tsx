...
function SynergistTypesSelector({ studies, onChange, value }: Props) {
  const uniques = R.uniq(R.map(R.prop("SYNERGIST_TYPE"), studies)).sort();
  ...
  return (
    <FilterWrapper>
      <FormLabel component="legend">
        <T i18nKey={"filters.synergist_types"} />
      </FormLabel>
      <Divider />
...
export default connect(mapStateToProps, null)(SynergistTypesSelector);
