    ...
    <div>
      ...
      <Trans i18nKey="step4.part1" t={t}>
        <b>
          ...
          <i>P. falciparum</i>, the two most common human malaria parasite
          species
        </b>
        </Trans>
      </Typography>
      ...
      <Trans i18nKey="step4.part3" t={t}>
        ...
        treatment for the most deadly malaria parasite, <i>P. falciparum</i>.
        There are two key outcome measures for monitoring the efficacy of ACTs:
        (1) the proportion of treatment failures and, (2) the proportion of
        patients with parasites on the third day after starting treatment. An
        increase in the proportion of patients with parasites on day 3 is a
      ...
      Chloroquine is still used in many places to treat <i>P. vivax</i>
        ...
        <i>P. vivax</i> parasites, some countries have shifted to ACTs for
