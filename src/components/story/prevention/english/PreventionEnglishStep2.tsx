    ...
    return (
        <div>
            ...
            <Typography variant={"body2"}>
                <b>
                    65 of 89 malaria-endemic countries have reported pyrethroid resistance in at least one local vector
                    since 2010
                </b>
            </Typography>
            <br />
            ...
            <Link
                ...
                color={"textSecondary"}
            >
                <img src="https://www.who.int/malaria/publications/atoz/9789241514057-eng.jpg" alt="prevention 2" />
            </Link>
        </div>
    );
};
